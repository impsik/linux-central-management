...
def _render_template_with_nonce(name: str, request: Request) -> str:
    ...
    html = html.replace("__PARTIAL_ADMIN_PANEL__", _read_template("partials/admin-panel.html"))
    html = html.replace("__PARTIAL_HOST_INVENTORY__", _read_template("partials/host-inventory.html"))
    html = html.replace("__PARTIAL_REPORTS_PANEL__", _read_template("partials/reports-panel.html"))
    html = html.replace("__PARTIAL_CRONJOBS_PANEL__", _read_template("partials/cronjobs-panel.html"))
    ...
    html = html.replace("__PARTIAL_USERS_TAB__", _read_template("partials/users-tab.html"))
    html = html.replace("__PARTIAL_TERMINAL_TAB__", _read_template("partials/terminal-tab.html"))
