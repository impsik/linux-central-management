(function (w) {
  ...
  function setupSshRefreshHandlers(opts) {
    ...
    const oidcEventsRefresh = document.getElementById('admin-oidc-events-refresh');
    if (oidcEventsRefresh) oidcEventsRefresh.addEventListener('click', function (e) { e.preventDefault(); if (typeof api.loadAdminOidcEvents === 'function') api.loadAdminOidcEvents(true); });
