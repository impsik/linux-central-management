"""schema catch-up for missing ORM tables

Revision ID: 20260416_00
Revises: 20260414_00
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("scope", sa.String(), nullable=False, server_default="hosts"),
    ...
    op.create_index("ix_host_cve_status_affected", "host_cve_status", ["affected"])
    op.create_index("ix_host_cve_status_checked_at", "host_cve_status", ["checked_at"])
    ...
    op.create_index("ix_host_metrics_snapshots_agent_recorded", "host_metrics_snapshots", ["agent_id", "recorded_at"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_host_cve_status_checked_at", table_name="host_cve_status")
    op.drop_index("ix_host_cve_status_affected", table_name="host_cve_status")
